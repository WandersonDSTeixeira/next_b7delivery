...
const Cart = (data: Props) => {
    ...
    const handleCartChange = (newCount: number, id: number) => {
        ...
        if (newCount > 0) tmpCart[cartIndex].qt = newCount;
        if (newCount === 0) delete tmpCart[cartIndex];
    ...
    const handleShipingCalc = () => {
        setShippingAddress('Rua das Flores')
